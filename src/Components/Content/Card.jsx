...
export default function RecipeCard({ idMeal, strMeal, strCategory, strMealThumb, strYoutube, strInstructions, handleCardClick }) {
  ...
  return (
    ...
    <Card sx={{ maxWidth: 445 }} onClick={() => handleCardClick(idMeal, strMeal, strCategory, strMealThumb, strYoutube, strInstructions)} style={{ margin: isSmallDevice ? '12px' : '17px' }}>
      <CardHeader
        avatar={
